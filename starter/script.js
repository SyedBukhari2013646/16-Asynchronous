...
<img class="country__img" src="${data.flags?.png || data.flags?.svg}" />
<div class="country__data">
  <h3 class="country__name">${data.name.common}</h3>
  <h4 class="country__regjhbjhbion">${data.region}</h4>
...
//       // ✅ RETURN fetch so it chains correctly
...
//       resolve('You won 💰');
//     } else {
//       reject(new Error('You loose the money 💩'));
//     }
//   }, 2000);
// });
...
//       reject(new Error(`Img not found ${imgPath}`));
//     });
//   });
// };
...
//   x += 4;
// } catch (err) {
//   alert(`BSDK sahe say kar naa ${err.message}`);
// }
...
//     // Reject proimise returned from the async function
//     throw err;
//   }
// };
...
// get3Countries('pakistan', 'bharat', 'palestine');
...
//       getJSON(`https://restcountries.com/v3.1/name/${c3}`),
//     ]);
//     console.log(data.map(d => d[0].capital));ggfsdbsrsgsgsrbgbbgeb// get3Countries('pakistan', 'bharat', 'palestine');
